...
return [
    ...
    */
    ...
    'project_logo'   => 'Black<b>Admin</b>',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    // 'header_class' => 'app-header bg-light border-0 navbar',--org
    ...
    // 'body_class' => 'app aside-menu-fixed sidebar-lg-show',--org
    'body_class' => 'app aside-menu-fixed sidebar-compact',
    // Try sidebar-hidden, sidebar-fixed, sidebar-compact, sidebar-lg-show

    // Sidebar element classes.
    // 'sidebar_class' => 'sidebar sidebar-pills bg-light',--org
    'sidebar_class' => 'sidebar sidebar-dark bg-white', // add "bg-white sidebar-pills" for light sidebar
    ...
    // 'footer_class' => 'app-footer d-print-none',--org
